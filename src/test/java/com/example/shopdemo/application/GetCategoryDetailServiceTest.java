...
class GetCategoryDetailServiceTest {
    ...
    void setUp() {
        ...
        getCategoryDetailService = new GetCategoryDetailService(categoryRepository);
    }
    ...
    void getCategory() {
        ...
        given(categoryRepository.findById(id)).willReturn(Optional.of(new Category(id, "top")));
