...
public class AdminProductControllerTest extends ControllerTest {
    ...
    void list() throws Exception {
        AdminProductSummaryDto productDto = new AdminProductSummaryDto("PRODUCT-ID",
                new CategoryDto("CATEGORY-ID", "Category"), new ImageDto("http://example.com/01.jpg"),
                "Product", 100_000L, false);

        given(getProductListService.getAdminProductListDto()).willReturn(new AdminProductListDto(List.of(productDto)));
    ...
    void detail() throws Exception {
        ...
        AdminProductDetailDto productDto = new AdminProductDetailDto(productId.toString(),
                new CategoryDto("CATEGORY-ID", "Category"),
                List.of(new ImageDto("http://example.com/01.jpg")),
                "Product", 100_000L, List.of(), "Description", false);

        given(getProductDetailService.getAdminProductDetailDto(productId)).willReturn(productDto);
    ...
    void update() throws Exception {
        ...
        mockMvc.perform(patch("/admin/products/123")
                        ...
                        .content(json))
                .andExpect(status().isOk());
        verify(updateProductService).updateProduct(eq(new ProductId("123")), any());
    }
